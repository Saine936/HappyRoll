  ...
  return (
    <header
      className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${
        solid
          ? "bg-background/92 backdrop-blur-md border-b border-border/70"
          : "bg-transparent"
      }`}
    >
      <div className="mx-auto max-w-[90rem] px-5 sm:px-8 flex items-center justify-between h-[70px] md:h-[86px]">
        <Link
          ...
          aria-label="Happy Rolls home"
        >
          <img
            src={logoUrl}
            alt="Happy Rolls"
            className="h-11 w-11 md:h-12 md:w-12 transition-transform duration-500 group-hover:scale-105"
          />
        ...
        <nav className="hidden lg:flex items-center gap-1">
                ...
                `relative px-4 py-2 font-sans text-sm font-medium tracking-wide transition-colors ${
                  ...
                  isActive
                    ? solid
                      ...
                      : "!text-white"
                    : ""
                } after:absolute after:left-4 after:right-4 after:-bottom-0.5 after:h-px after:origin-left after:scale-x-0 after:bg-current after:transition-transform after:duration-300 hover:after:scale-x-100 ${
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={`ml-3 inline-flex items-center gap-2 rounded-full px-5 py-2.5 font-sans text-sm font-medium tracking-wide transition-all duration-300 ${
              solid
                ? "bg-forest text-[hsl(var(--cream))] hover:bg-[hsl(var(--forest-deep))]"
        ...
        >
          {open ? (
            <X className="text-[hsl(var(--cream))]" />
          ) : (
            <Menu
              className={
      ...
      <div
        className={`lg:hidden fixed inset-0 bg-forest transition-all duration-500 ${
          open
          ...
          <nav className="flex flex-col gap-1">
            {NAV.map((item, index) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `font-display text-3xl py-3 border-b border-[hsl(var(--cream))]/15 transition-all duration-500 ${
                    open
